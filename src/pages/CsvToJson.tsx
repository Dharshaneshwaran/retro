...
function CsvToJson() {
  ...
  return (
    <div style={retroStyles.container}>
      <h1 style={retroStyles.title}>CSV to JSON Converter</h1>
      <p style={retroStyles.subtitle}>
        Transform your CSV files into structured JSON data with our retro-styled converter
      </p>
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          <FileCode2 size={48} style={{ margin: '0 auto', color: '#7a5230' }} />
      ...
      {file && (
        <div style={{ marginTop: '2rem' }}>
          ...
          >
            {converting ? 'Converting...' : converted ? 'Converted!' : 'Convert to JSON'}
          </button>
