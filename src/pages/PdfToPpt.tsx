...
function PdfToPpt() {
  ...
  return (
    <div style={retroStyles.container}>
      <h1 style={retroStyles.title}>PDF to PowerPoint Converter</h1>
      <p style={retroStyles.subtitle}>
        Transform your PDF documents into stunning presentations with our retro-styled converter
      </p>
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          <Presentation size={48} style={{ margin: '0 auto', color: '#7a5230' }} />
      ...
      {file && (
        <div style={{ marginTop: '2rem' }}>
          ...
          >
            {converting ? 'Converting...' : converted ? 'Converted!' : 'Convert to PowerPoint'}
          </button>
