...
function Home() {
  ...
  const converters = [
    ...
    { name: 'Compressing PDFs', icon: <FileText size={48} />, path: '/compressingPDFs' },
    ...
    { name: 'PDF Editor', icon: <FileText size={48} />, path: '/PDFEditor' },
  ];
      ...
      >
        {converters.map((converter) => (
          <div
            ...
            role="button"
            aria-label={`Navigate to ${converter.name} converter`}
            onMouseOver={(e) => {
